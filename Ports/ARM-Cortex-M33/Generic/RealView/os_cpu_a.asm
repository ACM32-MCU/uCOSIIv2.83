...
OS_CPU_PendSVHandler
    ...
    IF      {FPU} != "SoftVFP"
    TST     LR, #0x10                                           ; if(!EXC_RETURN[4]), The PE allocated space on the stack for FP context.
    VSTMFDEQ  R0!, {d8 - d15}                                   ; push FPU register s16~s31
    ENDIF

    STMFD   R0!, {R4-R11}                                       ; push R4-R11
...
OS_CPU_PendSVHandler_nosave
    ...
    LDR     R0, [R2]                                            ; R0 is new process SP; SP = OSTCBCur->OSTCBStkPtr;
